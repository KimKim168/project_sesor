    ...
    <div id='about_us' className="flex items-center justify-center">
      <div className="mx-auto grid w-full max-w-screen-xl items-center gap-12 px-6 py-16 lg:grid-cols-2">
        ...
        <div>
          ...
          <h2
            className="my-6 max-w-[17ch] text-4xl font-bold tracking-tight md:text-5xl lg:text-[2.75rem] xl:text-5xl"
          ...
          >
            <span className="relative whitespace-nowrap text-black dark:text-white">
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className="absolute bottom-0 left-0 h-[0.58em] w-full fill-purple-600/70 dark:fill-pink-300/60"
          ...
          <p className="mt-6 line-clamp-6 max-w-[60ch] text-lg">
            SESOR Express is a subsidiary company of Westec Corporation with
            roots deeply planted in Cambodia's business landscape for 16 years.
            Our management team comprises seasoned entrepreneurs and tech
            experts from diverse backgrounds, collectively bringing a wealth of
